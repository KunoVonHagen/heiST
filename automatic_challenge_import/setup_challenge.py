...
import time
import datetime
from automatic_challenge_import.upload_ova_file import upload_all_ova_files
...
if __name__ == "__main__":
    from automatic_challenge_import.get_authenticated_session import get_authenticated_session
